    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ListTile(leading: const Icon(Icons.tune_outlined), title: Text(l10n.playerSettings), subtitle: Text(l10n.playerSettingsDescription), trailing: const Icon(Icons.chevron_right), onTap: () => context.push('/settings/player')),
          ...
          _SliderTile(title: l10n.seekSensitivity, subtitle: l10n.seekSensitivityDescription, value: settings.seekSensitivity, min: .1, max: 1, divisions: 9, label: l10n.seekSensitivityValue((settings.seekSensitivity * 100).round()), onChanged: (value) => controller.saveChanges((current) => current.copyWith(seekSensitivity: value))),
        ],
      ),
    );
  }
