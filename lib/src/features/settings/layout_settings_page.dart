...
class LayoutSettingsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(appBar: AppBar(title: Text(l10n.interfaceLayout)), body: ListView(children: [
      ...
      SwitchListTile(secondary: const Icon(Icons.menu_open_outlined), title: Text(l10n.navigationDrawer), subtitle: Text(l10n.navigationDrawerDescription), value: settings.useNavigationDrawer, onChanged: (value) => controller.saveChanges((current) => current.copyWith(useNavigationDrawer: value))),
