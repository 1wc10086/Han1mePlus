        ...
        children: [
          ...
          Padding(
            ...
            child: M3EToggleButtonGroup(
              ...
              actions: [
                M3EToggleButtonGroupAction(icon: const Icon(Icons.brightness_auto_outlined), label: Text(l10n.followSystem), semanticLabel: l10n.followSystem),
                M3EToggleButtonGroupAction(icon: const Icon(Icons.light_mode_outlined), label: Text(l10n.light), semanticLabel: l10n.light),
                M3EToggleButtonGroupAction(icon: const Icon(Icons.dark_mode_outlined), label: Text(l10n.dark), semanticLabel: l10n.dark),
              ],
            ),
          ),
