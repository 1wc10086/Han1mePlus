        ...
        children: [
          Padding(
            ...
            child: SegmentedButton<bool>(
              segments: [
                ButtonSegment(value: true, label: Text(l10n.wallpaperColors)),
                ButtonSegment(value: false, label: Text(l10n.basicColors)),
              ],
              selected: {_useWallpaperColors},
              showSelectedIcon: false,
              onSelectionChanged: (value) => setState(() => _useWallpaperColors = value.first),
            ),
          ),
          ...
          Padding(
            ...
            child: SegmentedButton<AppThemeMode>(
              segments: [
                ButtonSegment(value: AppThemeMode.system, icon: const Icon(Icons.brightness_auto_outlined), label: Text(l10n.followSystem)),
                ButtonSegment(value: AppThemeMode.light, icon: const Icon(Icons.light_mode_outlined), label: Text(l10n.light)),
                ButtonSegment(value: AppThemeMode.dark, icon: const Icon(Icons.dark_mode_outlined), label: Text(l10n.dark)),
              ],
              selected: {settings.themeMode},
              showSelectedIcon: false,
              onSelectionChanged: (value) => controller.saveChanges((current) => current.copyWith(themeMode: value.first)),
            ),
          ),
          ...
          SwitchListTile(
            ...
            subtitle: Text(l10n.amoledModeDescription),
            value: settings.amoledMode,
            onChanged: (value) => controller.saveChanges((current) => current.copyWith(amoledMode: value)),
            ),
          ],
        ),
      );
