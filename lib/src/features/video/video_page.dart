    ...
    return Padding(
      ...
      child: LayoutBuilder(builder: (context, constraints) {
        ...
        for (final tag in widget.tags) {
          final estimatedWidth = (tag.length * 14.0 + 42).clamp(56.0, constraints.maxWidth).toDouble();
              ...
              for (final row in visibleRows)
                Padding(
                  ...
                  child: Wrap(
                    ...
                    spacing: 8,
                    runSpacing: 6,
                    children: row.map((tag) => ActionChip(label: Text('#$tag'), visualDensity: VisualDensity.compact, onPressed: () => context.push('/search', extra: _tagSearch(tag)))).toList(),
                  ),
                ),
