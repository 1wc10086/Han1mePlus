...
class _SearchPageState extends ConsumerState<SearchPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final useHorizontalCards =
        ref.watch(settingsProvider).value?.useHorizontalSearchCards ?? true;
    final cardsPerRow = ref.watch(settingsProvider).value?.searchCardsPerRow ?? 2;
                    ...
                    : LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          final cardWidth =
                              ...
                              cardsPerRow;
                          final cardHeight = useHorizontalCards
                              ? cardWidth * 9 / 16 + 70
                              : cardWidth / .62;
                          return GridView.builder(
                            ...
                            itemBuilder: (context, index) => VideoCardTile(
                              video: page.items[index],
                              horizontal: useHorizontalCards,
                            ),
                          );
                        },
                      ),
