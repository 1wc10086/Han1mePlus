      ...
      content: SizedBox(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: ListView(
                children: _tagGroups.entries.map((entry) => _TagGroup(title: _tagGroupLabel(l10n, entry.key), tags: entry.value, selected: _selected, onChanged: (tag, selected) => setState(() => selected ? _selected.add(tag) : _selected.remove(tag)))).toList(),
              ),
            ),
          ],
        ),
...
const _tagGroups = <String, List<String>>{
