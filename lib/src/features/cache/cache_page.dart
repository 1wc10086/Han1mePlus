           ...
           child: Column(
            ...
            children: [
              Text(label, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w600)),
               if (task.status == DownloadStatus.downloading || task.status == DownloadStatus.queued) M3ELinearProgressIndicator(value: task.status == DownloadStatus.downloading ? task.progress : null),
