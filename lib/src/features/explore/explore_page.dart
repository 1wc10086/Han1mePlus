    ...
    if (expanded) LayoutBuilder(
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: cardsPerRow, mainAxisSpacing: 12, crossAxisSpacing: spacing, mainAxisExtent: cardHeight),
          itemCount: section.videos.length,
          itemBuilder: (_, index) => VideoCardTile(video: section.videos[index], horizontal: horizontal),
        );
      },
    ) else Builder(
      builder: (context) {
        ...
        return SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (_, index) => SizedBox(width: cardWidth, child: VideoCardTile(video: section.videos[index], horizontal: horizontal)),
          ),
        );
      },
    ),
