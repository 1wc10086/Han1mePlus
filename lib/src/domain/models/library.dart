class FollowingVideo {
  const FollowingVideo({required this.videoCode, required this.title, required this.addedAt, this.coverUrl, this.artistName, this.artistAvatarUrl, this.genre, this.playlistItemId});
