...
class PreviewItem {
  const PreviewItem({required this.id, required this.title, required this.coverUrl, this.videoTitle, this.brand, this.releaseDate, this.description, this.tags = const []});
