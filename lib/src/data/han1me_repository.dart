...
import 'remote/http_cache.dart';

final han1meRepositoryProvider = Provider((_) {
  ...
  ))..interceptors.add(HttpCacheInterceptor());
  return Han1meRepository(Han1meApi(dio));
});
...
class Han1meRepository {
  ...
  Future<HomeFeed> home(String baseUrl) => _merge('home:$baseUrl', () => _api.home(baseUrl));
