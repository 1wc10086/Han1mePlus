  ...
  Widget build(BuildContext context, WidgetRef ref) => Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            ListTile(leading: const Icon(Icons.code_outlined), title: Text(AppLocalizations.of(context)!.version), subtitle: const Text('1.0.9')),
            ...
            ListTile(leading: const Icon(Icons.bug_report_outlined), title: Text(AppLocalizations.of(context)!.reportIssue), subtitle: Text(AppLocalizations.of(context)!.submitGitHubIssue), trailing: const Icon(Icons.open_in_new), onTap: () => launchUrl(Uri.parse('https://github.com/1wc10086/Han1mePlus/issues/new/choose'), mode: LaunchMode.externalApplication)),
             ListTile(leading: const Icon(Icons.gavel_outlined), title: Text(AppLocalizations.of(context)!.openSourceLicense), trailing: const Icon(Icons.chevron_right), onTap: () => showLicensePage(context: context, applicationName: 'Han1me+', applicationVersion: '1.0.9')),
            const Divider(),
